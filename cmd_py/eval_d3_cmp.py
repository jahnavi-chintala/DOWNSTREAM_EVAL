...
CONFIG_PATH = BASE_DIR / "eval_config" / "cmp_eval_config.yaml"
...
def _write_word_report_path(report: dict, output_path: Path) -> None:
    ...
    try:
        from cmp_report_docx import write_cmp_eval_docx
...
def main():
    ...
    for filepath in files_to_eval:
        ...
        if not args.no_yaml:
            try:
                from cmp_eval_report_yaml import write_cmp_eval_report_yaml
