...
from core.dmp_data import generation_fallback_used
from core.semantic_matcher import SemanticMatcher, verbatim_semantic_attribute_score, weighted_average
