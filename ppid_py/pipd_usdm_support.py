...
from eval_scenario1 import NULL_PLACEHOLDERS, PROVENANCE_EXEMPT_CONFIDENCE, load_generator_json
from pipd_usdm_provenance import (
...
def build_usdm_and_truth_block(
    ...
    for sub in flat_subs:
        ...
        src_line, src_meth = resolve_usdm_source_for_subcategory(
