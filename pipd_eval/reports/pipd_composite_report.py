...
from core.pipd_composite_eval import run_composite_eval, save_composite_json
...
def _scenario1_eval_markdown(s1: Dict[str, Any]) -> List[str]:
    ...
    lines.append(
        f"| M4 Traceability Flags | {m4.get('traceability_flag_count', m4.get('hallucinations_found', '—'))} | "
