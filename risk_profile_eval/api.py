...
from run_all_verify import run_all_verify
from risk_profile_json_to_docx import write_risk_profile_docx
...
async def readiness_check() -> Dict:
    ...
    eff_risks = GROUND_TRUTH_RISKS or str(_pkg / "data" / "risk_profile_ground_truth.csv")
    eff_factors = GROUND_TRUTH_FACTORS or str(_pkg / "data" / "critical_factors_ground_truth.csv")
...
async def eval_scenario1(req: Scenario1Request) -> EvalResponse:
    ...
    Accuracy, M3 Critical Factor Match, M4 Hallucination Detection), saves output
